...
public class Ctrl_ListaRevision extends SelectorComposer{
	...
	public void editar(){
		...
		Window ventanaCargar = (Window)Executions.createComponents("/A_Proyectos_Revision/IngresaRevision.zul", winListaEmpleados,params);
